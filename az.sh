...
sudo -S <<< "Azure.123456@e" scp -r /var/root/.jenkins/workspace/Azure/hello-world-war-1.0.0.war azureuser@40.121.48.14:/home/azureuser/apache-tomcat-9.0.27/webapps -yes
exit
ENDSSH
